package edu.casetools.mreasoner.compiler;
...
public class MSpecificationLoader {
	...
	public MSpecification readSystemSpecifications_RealTime(String configsFileName) throws FileNotFoundException, edu.casetools.mreasoner.compiler.realtime.ParseException{
		MCompiler reader = new MCompiler(new FileReader(configsFileName));
		return reader.readSystemSpecifications();
	}
	
	public MSpecification readSystemSpecifications_Iteration(String configsFileName) throws FileNotFoundException, edu.casetools.mreasoner.compiler.iterations.ParseException{
		MCompiler_Iteration reader = new MCompiler_Iteration(new FileReader(configsFileName));
		return reader.readSystemSpecifications();
	}
	
	public MSpecification getMSpecification(EXECUTION_MODE mode, String specificationFilePath) throws FileNotFoundException, edu.casetools.mreasoner.compiler.iterations.ParseException, edu.casetools.mreasoner.compiler.realtime.ParseException{
